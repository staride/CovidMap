  ...
  <v-container class="fill-height" fluid>
    <v-row align="center" justify="center">
      <v-col cols="12" sm="6">
        ...
        <v-card-text>
          <v-text-field label="title" v-model="board.title" :rules="titleRule" prepend-icon="mdi-lock" type="text"></v-text-field>
          <v-textarea height="300" v-model="board.contents" label="contents" :rules="contentsRule" prepend-icon="mdi-lock" type="text"></v-textarea>
        </v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
